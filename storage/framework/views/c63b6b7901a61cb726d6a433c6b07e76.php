    ...
    <div class="admin-container">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $users ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td><strong><?php echo e($user->name ?? 'Sin nombre'); ?></strong></td>
                        ...
                        <td>
                            <?php if(isset($user->business) && $user->business): ?>
                                <?php echo e($user->business->name ?? 'N/A'); ?>
                        ...
                        <td>
                            <?php if(!$user->isAdmin()): ?>
                                <form action="<?php echo e(route('admin.users.delete', $user->id)); ?>" method="POST" style="display: inline;" onsubmit="return confirm('¿Estás seguro de eliminar este usuario?');">
                                    <?php echo csrf_field(); ?>
        ...
        <?php if(isset($users) && method_exists($users, 'links')): ?>
            <div class="pagination-info">
                Mostrando <?php echo e($users->firstItem() ?? 0); ?> a <?php echo e($users->lastItem() ?? 0); ?> de <?php echo e($users->total()); ?> resultados
            </div>
...
<?php /**PATH C:\laragon\www\BermejaClick\resources\views/admin/users.blade.php ENDPATH**/ ?>