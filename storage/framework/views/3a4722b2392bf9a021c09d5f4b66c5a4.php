...
<body>
    <div class="admin-container">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                <h3>Logins Hoy</h3>
                <div class="value"><?php echo e($activityStats['logins_today']); ?></div>
            </div>
            <div class="stat-card">
                <h3>Logins Esta Semana</h3>
                <div class="value"><?php echo e($activityStats['logins_this_week']); ?></div>
            </div>
            <div class="stat-card">
                <h3>Logins Fallidos Hoy</h3>
                <div class="value text-danger"><?php echo e($activityStats['failed_logins_today']); ?></div>
            </div>
            <div class="stat-card">
                <h3>Actividades Hoy</h3>
                <div class="value"><?php echo e($activityStats['total_activities_today']); ?></div>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($log->user): ?>
                                            ...
                                            <small style="color: #6c757d;"><?php echo e($log->user->email); ?></small>
                                        <?php else: ?>
                                            <span style="color: #6c757d;">
                                                <?php if($log->metadata && isset($log->metadata['email'])): ?>
                                                    <?php echo e($log->metadata['email']); ?>
                                    ...
                                    <td>
                                        <span class="action-<?php echo e($log->action); ?>">
                                            <i class="fas fa-<?php echo e($log->action === 'login' ? 'sign-in-alt' : ($log->action === 'logout' ? 'sign-out-alt' : ($log->action === 'login_failed' ? 'exclamation-triangle' : ($log->action === 'update' ? 'edit' : ($log->action === 'create' ? 'plus' : 'trash'))))); ?>"></i>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $loginLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td><small><?php echo e($log->ip_address); ?></small></td>
                                    <td><small style="color: #6c757d;"><?php echo e(Str::limit($log->user_agent, 50)); ?></small></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                                    <td colspan="6" style="text-align: center; padding: 2rem; color: #6c757d;">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $errorLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td><?php echo e($log->description); ?></td>
                                    <td>
                                        <?php if($log->metadata && isset($log->metadata['reason'])): ?>
                                            <span class="badge badge-danger"><?php echo e($log->metadata['reason']); ?></span>
                                        <?php else: ?>
        ...
        <div style="margin-top: 2rem; text-align: center;">
            <a href="<?php echo e(route('admin.businesses')); ?>" style="display: inline-block; margin: 0.5rem; padding: 0.75rem 1.5rem; background: #8B4513; color: white; text-decoration: none; border-radius: 8px;">
                <i class="fas fa-store"></i> Gestionar Negocios
            </a>
            <a href="<?php echo e(route('admin.users')); ?>" style="display: inline-block; margin: 0.5rem; padding: 0.75rem 1.5rem; background: #1E90FF; color: white; text-decoration: none; border-radius: 8px;">
                <i class="fas fa-users"></i> Gestionar Usuarios
            </a>
            <a href="<?php echo e(route('admin.register')); ?>" style="display: inline-block; margin: 0.5rem; padding: 0.75rem 1.5rem; background: #C97D60; color: white; text-decoration: none; border-radius: 8px;">
                <i class="fas fa-user-plus"></i> Crear Nuevo Comercio
            </a>
            <a href="<?php echo e(route('admin.promotions')); ?>" style="display: inline-block; margin: 0.5rem; padding: 0.75rem 1.5rem; background: #228B22; color: white; text-decoration: none; border-radius: 8px;">
                <i class="fas fa-tags"></i> Gestionar Promociones
            </a>
            <a href="<?php echo e(route('dashboard')); ?>" style="display: inline-block; margin: 0.5rem; padding: 0.75rem 1.5rem; background: #6c757d; color: white; text-decoration: none; border-radius: 8px;">
...
<?php /**PATH C:\laragon\www\BermejaClick\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>