...
<head>
    ...
    <title>{{ $business->name ?? 'Comercio' }} - BermejaClick.co</title>
        ...
        <div class="container">
            ...
            <div class="business-detail-hero">
                ...
                <div class="business-detail-info">
                    <h1 class="business-detail-name">{{ $business->name ?? 'Sin nombre' }}</h1>
                    <div class="business-detail-category">
                        <i class="fas fa-tag"></i>
                        <span>{{ $business->category->name ?? 'General' }}</span>
                    </div>
                    <div class="business-detail-description">
                        {{ $business->description ?? 'Descubre este increíble comercio en Barrancabermeja.' }}
                    </div>
                </div>
            </div>
            ...
            <div class="promotions-section">
                ...
                @if($activePromotions && $activePromotions->count() > 0)
                    <div class="promotions-grid">
                        @foreach($activePromotions as $promo)
                            <div class="promotion-card">
                                <div class="promotion-badge">-{{ $promo->discount_percentage ?? 0 }}%</div>
                                ...
                                <div class="promotion-content">
                                    ...
                                    <p class="promotion-description">
                                        {{ \Illuminate\Support\Str::limit($promo->description ?? 'Sin descripción', 100) }}
                                    </p>
