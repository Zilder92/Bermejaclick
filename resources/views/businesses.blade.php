    ...
    <header class="header">
        <nav class="navbar">
            <div class="container">
                ...
                <ul class="nav-menu">
                    <li><a href="{{ route('home') }}#promociones">Promociones</a></li>
                    <li><a href="{{ route('home') }}#turismo">Turismo</a></li>
                    <li><a href="{{ route('home') }}#hoteles">Hoteles</a></li>
                    <li><a href="{{ route('home') }}#comidas">Comidas</a></li>
        ...
        <div class="businesses-hero">
            <div class="header-image-carousel">
                <div class="carousel-container">
                    <div class="carousel-slide active" style="background-image: url('{{ asset('images/barrancabermeja/Barrancabermeja_1.jpg') }}');"></div>
                    <div class="carousel-slide" style="background-image: url('{{ asset('images/barrancabermeja/Barrancabermeja_2.jpg') }}');"></div>
                    <div class="carousel-slide" style="background-image: url('{{ asset('images/barrancabermeja/Barrancabermeja_3.jpg') }}');"></div>
                    <div class="carousel-slide" style="background-image: url('{{ asset('images/barrancabermeja/Barrancabermeja_4.jpg') }}');"></div>
                    <div class="carousel-slide" style="background-image: url('{{ asset('images/barrancabermeja/Barrancabermeja_5.jpg') }}');"></div>
                </div>
                ...
                <div class="businesses-hero-content">
                    ...
                    <div class="businesses-hero-stats">
                        <div class="hero-stat">
                            <span class="hero-stat-number">{{ $totalBusinesses ?? 0 }}</span>
                            <span class="hero-stat-label">Comercios</span>
                        </div>
                        <div class="hero-stat">
                            <span class="hero-stat-number">{{ $totalCategories ?? 0 }}</span>
                            <span class="hero-stat-label">Categorías</span>
                        </div>
                        <div class="hero-stat">
                            <span class="hero-stat-number">{{ $totalPromotions ?? 0 }}</span>
        ...
        <div class="container">
            ...
            <div class="businesses-filters-wrapper">
                <div class="businesses-filters">
                    <form method="GET" action="{{ route('businesses.index') }}" class="filter-form">
                        ...
                        @if(request('buscar') || request('categoria'))
                            <div class="filter-group" style="flex: 0 0 auto;">
                                <a href="{{ route('businesses.index') }}" class="btn-filter-clear">
            ...
            <div class="businesses-content">
                <div class="business-profiles-grid">
                    @forelse($businesses ?? [] as $business)
                        <a href="{{ route('businesses.show', $business->slug) }}" class="business-card-link">
                            <div class="business-profile-card">
                                <div class="business-profile-image">
                                    @if(isset($business->logo) && $business->logo)
                                        <img src="{{ asset('storage/' . $business->logo) }}" alt="{{ $business->name ?? 'Comercio' }}">
                                    @elseif(isset($business->cover_image) && $business->cover_image)
                                        <img src="{{ asset('storage/' . $business->cover_image) }}" alt="{{ $business->name ?? 'Comercio' }}">
                                    @else
                                ...
                                <div class="business-profile-content">
                                    ...
                                    <h3 class="business-profile-name">{{ $business->name ?? 'Sin nombre' }}</h3>
                                    <p class="business-profile-description">
                                        {{ \Illuminate\Support\Str::limit($business->description ?? 'Descubre este increíble comercio en Barrancabermeja.', 120) }}
                                    </p>
                                    @if($business->promotions && $business->promotions->count() > 0)
                                        <div class="business-promotions-badge">
                                            <i class="fas fa-tags"></i>
                                            <span>{{ $business->promotions->count() }} {{ $business->promotions->count() == 1 ? 'promoción activa' : 'promociones activas' }}</span>
                                        </div>
                                    @endif
                                </div>
                            </div>
